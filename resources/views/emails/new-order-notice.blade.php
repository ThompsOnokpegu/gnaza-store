...
<section class="flex items-center py-10 bg-gz-brown-400 md:py-15 font-poppins">
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-5 sm:mx-auto bg-white sm:border border-gz-brown-300 rounded-md md:py-10 md:px-10">
       <div>
          ...
          <p class="px-4 text-xl font-normal tracking-wide text-black-300 ">
             You have a new order from <span class="font-semibold">{{ $order->user->name }}</span>. 
          </p>
          
          <div class="flex flex-wrap items-center pb-4 pt-12 mb-10 border-b border-gz-brown-300">
