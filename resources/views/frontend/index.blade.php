    ...
    <div class="items-center flex flex-col-reverse lg:px-16">
        <div class="w-full items-center justify-center mt-6">
            <div class="text-center mx-3">
                ...
                <a href="{{ route('shop') }}" class="px-1 border-b mt-2 border-b-black text-md font-ridley tracking-wider text-black transition-colors duration-300 transform bg-blue-600 lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Shop Gnaza Collection</a>
            </div>
        </div>
        ...
        <div class="w-full items-center justify-center mt-6">
            <div class="text-center mx-3">
                ...
                <p class="my-4 text-sm text-gray-600 font-normal font-montserrat tracking-wider">Accessorize your look with a bold statement necklace or add some
                    ...
                    <a href="{{ route('archive',['category'=>'necklaces']) }}" class="px-1 border-b mt-2 border-b-black text-md font-ridley tracking-wider text-black transition-colors duration-300 transform bg-blue-600 lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Shop the collection</a>
            </div>
        </div>

        <div class="flex items-center justify-center w-full mt-0">
            <img class="w-full" src="{{asset('frontend/images/gnaza_1920 x 800.avif')}}" alt="Catalogue-pana.svg">
        </div>
    </div>
</div>
            ...
            <div class="text-center mx-3">
                <div class="space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0 z-1">
                    <div class="group relative z-1">
                        ...
                        <a href="{{ route('archive',['category'=>'bracelets']) }}" class="px-1 border-b mt-2 border-b-black text-md font-ridley tracking-wider text-black transition-colors duration-300 transform bg-blue-600 lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Shop the collection</a>
                    ...
                    <div class="group relative">
                        ...
                        <a href="{{ route('archive',['category'=>'jewelry-set']) }}" class="px-1 border-b mt-2 border-b-black text-md font-ridley tracking-wider text-black transition-colors duration-300 transform bg-blue-600 lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Shop the collection</a>
                    </div>
                    <div class="group relative">
                        <div class="relative h-80 w-full overflow-hidden bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
                        <img src="{{ asset('frontend/images/earrings.png') }}" alt="Gnaza Jewelry Matching Jewelry Set Collections." class="h-full w-full object-cover object-center">
                        </div>
                        <h3 class="mt-6 text-lg text-gray-500">
                        <a href="{{ route('archive',['category'=>'earrings']) }}" class="font-ridley tracking-wider uppercase" >
                            <span class="absolute inset-0"></span>
                            Earrings
                        </a>
                        </h3>
                        <p class="my-3 text-sm font-normal font-montserrat tracking-wider text-gray-900">Fashionable ear adornments.</p>
                        <a href="{{ route('archive',['category'=>'earrings']) }}" class="px-1 border-b mt-2 border-b-black text-md font-ridley tracking-wider text-black transition-colors duration-300 transform bg-blue-600 lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Shop the collection</a>
                    </div>
