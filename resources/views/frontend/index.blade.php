    ...
    <div class="mx-auto max-w-screen-xl px-8">
        <div class="grid grid-cols-12 items-center">
            ...
            <div class="flex flex-col gap-y-4 mb-5 py-8 sm:p-0">
                <h1 class="text-5xl sm:text-5xl md:text-7xl leading-normal sm:mb-7 font-playfair text-gz-black-200">Elevate Your
                    <span class=" mt-0 font-meddon text-gz-brown-200 text-6xl">Everyday</span>
                </h1>
            ...
            <a href="{{ route('shop') }}" type="button" class="inline-block border border-black px-6 py-4 text-xl text-black hover:text-gz-brown-100 font-thin leading-tight uppercase hover:bg-gz-brown-300 hover:border-gz-brown-300">EXPLORE PRODUCTS</a>
            </div>
...
<section class="flex items-center bg-white flex-col pt-15 pb-24 z-1">
    ...
    <div class="px-4 mx-auto max-w-7xl">
            ...
            <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
                ...
                <div class="mt-6 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0 z-1">
                    <div class="group relative z-1">
                        ...
                        <a href="{{ route('archive',['category'=>'bracelets']) }}" class="font-ridley z-1 uppercase">
                    ...
                    <div class="group relative">
                        <div class="relative h-80 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
                        <img src="{{ asset('frontend/images/gnaza-jewelry-set.webp') }}" alt="Gnaza Jewelry Earrings Collections." class="h-full w-full object-cover object-center">
                        </div>
                        <h3 class="mt-6 text-lg text-gray-500">
        ...
        <p class="font-ridley text-center font-semibold uppercase text-lg">Make you shine on ordinary days</p>
        <h1 class="text-6xl font-thin font-ridley text-center text-gray-900">Our Best Sellers</h1>
         <!--product row 1-->
                                ...
                                <div class="relative overflow-hidden">
                                    <div class="mb-5 overflow-hidden">
                                        <img class="object-cover w-full mx-auto transition-all rounded h-72 hover:scale-110"
                                            ...
                                            alt="gnaza-jewelry-{{ $product->slug }}">
                                    </div>
                                </div>
                                <h3 class="mb-2 uppercase text-xl font-ridley text-gz-black-200 ">{{ $product->name }}</h3>
