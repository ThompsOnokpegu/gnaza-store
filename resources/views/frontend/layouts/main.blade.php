...
<html>
    ...
    <body>
        ...
        <nav x-data aria-label="Site Navbar" class="shadow sticky top-0 bg-white z-40">
            <div class="">
                {{-- top-menu --}}
                <div class="mx-auto max-w-screen-xl px-4 py-4">
                    <div class="flex items-center justify-between gap-x-8">
                        ...
                        <li class="flex items-center gap-x-4 md:hidden">
                            ...
                            >
                            <svg x-ref="menu" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" class="h-9 w-12 stroke-gz-brown-100 z-50">
