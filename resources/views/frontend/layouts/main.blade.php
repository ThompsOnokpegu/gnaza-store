                ...
                <div class="mx-auto max-w-screen-xl px-4 py-3">
                    <div class="flex items-center justify-between gap-x-4">
                        <ul class="flex items-center gap-x-3">
                            <li>
                                <a class="cursor-pointer text-gz-brown-300 hover:text-gray-900/70">
