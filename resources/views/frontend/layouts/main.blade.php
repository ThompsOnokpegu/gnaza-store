        ...
        <nav x-data aria-label="Site Navbar">
            <div class="">
                ...
                <ul class="mx-auto max-w-screen-xl px-4 py-4">
                    ...
                    <li>
                    <a class="block cursor-pointer rounded-full p-2 text-center text-sm font-medium hover:bg-gray-900 hover:text-gray-50">NECKLACES</a>
                    </li>
                    <li>
                    <a class="block cursor-pointer rounded-full p-2 text-center text-sm font-medium hover:bg-gray-900 hover:text-gray-50">BRACELETS</a>
                    </li>
                    <li>
                    <a class="block cursor-pointer rounded-full p-2 text-center text-sm font-medium hover:bg-gray-900 hover:text-gray-50">EARRINGS</a>
                    </li>
                </ul>
                </div>
            </div>
