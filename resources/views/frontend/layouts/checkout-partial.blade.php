    ...
    <body>
        ...
        <footer aria-label="Site Footer" class="bg-black">
            <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <a href="{{ route('home') }}">
                    <img class="h-12 w-auto mx-auto object-contain" src="{{ asset('frontend/images/gnaza-logo-200.png') }}" alt="logo" />
                </a>
                ...
                <li>
                    <a target="_blank" class="cursor-pointer text-gz-brown-200 transition hover:text-gray-800/75">
                ...
                <li>
                    <a class="cursor-pointer text-gz-brown-200 transition hover:text-gray-800/75">
                ...
                <div class="mx-auto mt-12 w-full text-center leading-relaxed text-gz-brown-200">&copy; {{ now()->year }} All right reserved</div>
            </div>
