<div class="lg:pl-20">
    ...
    <a href="#" wire:click.prevent="addToCart" class="w-full px-4 py-3 text-center text-gz-brown-100 bg-gz-brown-300 border border-gz-brown-300 hover:text-gz-brown-400 hover:bg-gz-brown-200 lg:w-1/2">
    Add to cart
    </a>
    </div>
    <div class="flex gap-4 mb-6">
    <a href="{{ route('cart') }}" wire:click="buyNow" class="w-full px-4 py-3 text-center text-white bg-gz-brown-200 border border-transparent hover:border-yellow-500 hover:text-gz-brown-400 hover:bg-gz-brown-100">
    View Cart</a>
    </div>
</div>