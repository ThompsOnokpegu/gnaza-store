<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 py-14">
    <div class="px-4 pt-8">
      ...
      <div wire:loading.class="opacity-50" class="mt-8 space-y-3 rounded-lg border border-gz-black-700 px-2 py-4 sm:px-6">
        ...
        <div class="flex flex-row rounded-lg">
          ...
          <div class="flex w-full flex-col px-4 py-4">
            ...
            <span class="float-right uppercase text-gz-black-700">from {{ $item->associatedModel->category->name }}</span>
      ...
      <form wire:loading.class="opacity-50" class="mt-5 grid gap-6">
        <div class="relative">
          ...
          <span class="peer-checked:border-gz-brown-200 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gz-black-700 bg-white"></span>
          <label wire:click="calculateShipping('pickup')" class="peer-checked:border-2 peer-checked:border-gz-brown-200 peer-checked:bg-gz-brown-400 flex cursor-pointer select-none rounded-lg border border-gz-black-700 p-4" for="radio_2">
            <img class="w-10 object-contain" src="{{ asset('frontend/images/pickup.png') }}" alt="" />
            <div class="ml-5">
              <span class="mt-2 font-semibold">Pickup (10AM - 4PM)</span>
              <p class="text-slate-500 text-sm leading-6">TK Mall, Kubwa.</p>
        ...
        <div class="relative">
          ...
          <span class="peer-checked:border-gz-brown-200 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gz-black-700 bg-white"></span>
          <label wire:click="calculateShipping('door')" class="peer-checked:border-2 peer-checked:border-gz-brown-200 peer-checked:bg-gz-brown-400 flex cursor-pointer select-none rounded-lg border border-gz-black-700 p-4" for="radio_1">
    ...
    <div wire:loading.class="opacity-50" class="mt-10  px-4 pt-8 lg:mt-0 rounded-l items-center">
        ...
        <div class="">
            ...
            <div class="relative">
                <input type="text" id="email" wire:model="billing_email" class="w-full rounded-md border border-gz-black-700 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="your.email@gmail.com" />
            ...
            <div class="relative">
                <input type="text" id="card-holder" wire:model="billing_name" class="w-full rounded-md border border-gz-black-700 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="Your full name" />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            ...
            <div class="relative w-full flex-shrink-0">
                <input type="text" id="card-no" wire:model="billing_phone" class="w-full rounded-md border border-gz-black-700 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="+234-808-888-8888" />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                    <img class="h-4 w-4 object-contain" src="{{ asset('frontend/images/phone.svg') }}" alt="" />
                </div>
            </div>
            
            {{-- <input type="text" name="credit-expiry" class="w-full rounded-md border border-gz-black-700 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="MM/YY" />
            <input type="text" name="credit-cvc" class="w-g1/6 flex-shrink-0 rounded-md border border-gz-black-700 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="CVC" /> --}}
            </div>
            @error('billing_phone')
                <span class="text-gz-danger">{{ $message }}</span>
            @enderror
            ...
            <div class="relative flex-shrink-0 sm:w-7/12">
                <input type="text" id="billing-address" wire:model="billing_address" class="w-full rounded-md border border-gz-black-700 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300" placeholder="Street Address" />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            ...
            <select type="text" wire:model="billing_city" class="w-full rounded-md border border-gz-black-700 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-gz-brown-200 focus:ring-gz-brown-300">   
            ...
            @enderror
            <!-- Total -->
            <div class="mt-6 border-t border-b border-gz-black-700 py-2">
        ...
        <button wire:click="placeOrder" wire:loading.class="opacity-50" wire:loading.attr="disabled" class="mt-4 mb-8 w-full bg-black px-6 py-3 font-medium text-white">Place Order </button>
