      ...
      <div class="px-4 py-6 sm:px-8 sm:py-10">
        ...
        <div class="mt-6 border-t border-b border-gz-brown-300 py-2">
          ...
          <div class="flex items-center justify-between">
            ...
            <p class="text-sm font-thin text-gray-900">Decided during checkout</p>
          </div>
        </div>
        ...
        <div class="mt-6 text-center">
          <a href="{{ route('shop') }}" type="button" class="group inline-flex w-full items-center justify-center border border-gz-brown-100 px-6 py-4 text-lg font-semibold text-gz-brown-100 transition-all duration-200 ease-in-out focus:shadow hover:bg-gz-brown-200 hover:text-white hover:border-none">
            Continue Shopping
          </a>
        </div>
      </div>
